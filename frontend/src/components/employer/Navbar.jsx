    ...
    <AppBar position="static">
      <Toolbar>
        ...
        <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
          ...
          <Button sx={{ marginRight:'10px',color: 'white',textDecoration: 'none', // Set your desired background color here
        ...
        '&:hover': {backgroundColor:'darkblue',}}}  >
          ...
          <Button sx={{ marginLeft:'10px',color: 'white',textDecoration: 'none',backgroundColor: '#4CAF50', // Set your desired background color here
